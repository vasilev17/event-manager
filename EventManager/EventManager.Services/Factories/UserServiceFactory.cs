...
namespace EventManager.Services.Factories
{
    public class UserServiceFactory : IUserServiceFactory
    {
        ...
        public UserServiceFactory(IUserRepository userRepository, IJwtService jwtService, IMapper mapper)
        {
        ...
        {
            var coreService = new UserService(_repository, _jwtService, _mapper);
